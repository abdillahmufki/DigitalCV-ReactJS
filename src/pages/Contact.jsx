            ...
            <Col lg={12}>
              <div className="dark:text-white">
                <h2 className="text-3xl">
                  Kami dapat membantu anda mewujudkan ide anda menjadi
                  kenyataan, ambil project yang sudah ada, atau perpanjang
              ...
              <div>
                <div className="dark:text-white">
                  ...
                  <br />
                  <p className="text-slate-500">
                    Protip — touch base on: Ide Anda, timeline Anda, dan
                    anggaran Anda.
                  </p>
                </div>
                <Row className="my-5">
